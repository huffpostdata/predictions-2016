...
CalculateDiffData <- function(state_code, chart_slug, cook_rating, dem_label, gop_label, fast) {
  ...
  #   cook_rating: Cook rating: one of {D-Solid,D-Likely,D-Lean,Toss Up,R-Lean,R-Likely,R-Solid}
